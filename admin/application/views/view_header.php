...
<div id="main_container">
	...
	<div class="header">
    <div class="logo"><a href="#">Vogram</a></div>
    
    <div class="right_header"><a href="<?php echo site_url('login/odjava'); ?>" class="logout">Odjava</a></div>
    <div id="clock_a"></div>
    </div>
  ...
  <br>
    ...
    <div class="left_content">
            ...
            <?php 	$attributes = array('name' => 'pretraga');
					echo  form_open('vog/pretraga', $attributes);
			?>
            <input type="text" name="pretraga" class="search_input" value="pretraga jos ne radi..." onclick="this.value=''" /> 
            ...
            <div class="sidebarmenu">
                ...
                <a class="menuitem submenuheader" href="" >Projekti</a>
                <div class="submenu">
                    <ul>
